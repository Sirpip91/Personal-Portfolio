      ...
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div>
          ...
          <h1 className='py-4 text-gray-700'>
            Hi, I&#39;m <span className='text-[#0e6fff]'> Bradley</span>
          </h1>
          <h1 className='py-2 text-gray-700'>A Software Engineer</h1>
          <p className='py-4 text-gray-600 sm:max-w-[70%] m-auto'>
            I’m focused on building software solutions that have an impact while providing value.
          ...
          <div className='flex items-center justify-between max-w-[330px] m-auto py-4'>
            ...
            <a href="/Bradley_Allen_Resume.pdf">
              <div className='rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300'>
                <AiOutlineMail />
              </div>
            </a>
