  ...
  return (
    <div id='projects' className='w-full'>
      <div className='max-w-[1240px] mx-auto px-2 py-16'>
        ...
        <p className='py-4 text-gray-900 text-xl '>These are a couple of my favorite ❤️ projects, checkout my <a href="https://github.com/Sirpip91"className='underline cursor-pointer'>Github</a> to see more code!</p>
        <br />
